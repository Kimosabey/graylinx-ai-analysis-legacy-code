...
// export default function FloorMapGenerator01(props,{
...
//                     "meeting_room_id": "18f094dd-e9ea-4c22-9c65-0d2c956cbbfb",
//                     "shape": "rect",
//                     "coords": [
//                         50,
//                         325,
...
//                 {
//                     "name": "ceo-office",
//                     "meeting_room_id": "d611ddd1-0888-434a-bde4-d2e2a81f3936",
//                     "shape": "rect",
//                     "coords": [
//                         50,
//                         25,
...
//                 {
//                     "name": "control-room",
//                     "meeting_room_id": "a3ca8648-9db9-404d-88da-1e6b14bc88bb",
//                     "shape": "rect",
//                     "coords": [
//                         50,
//                         125,
...
//                 {
//                     "name": "refresh-room",
//                     "meeting_room_id": "28c792c7-53f8-406c-be69-5eda595e4222",
//                     "shape": "rect",
//                     "coords": [
//                         300,
//                         25,
...
//                 {
//                     "name": "pantry-room",
//                     "meeting_room_id": "7363fdeb-9f8a-4dbf-bc2a-495d2285aa52",
//                     "shape": "rect",
//                     "coords": [
//                         450,
//                         25,
...
//     const [mapSubType, setMapSubType] = React.useState(props.type)
//     const [floorAreas,setFloorAreas]=React.useState({})
//     const[stype,setStype]=React.useState('')

//     const defineFloorColor=(defaultData,response,roomJSONpaths)=>{
      
//         let temp=defaultData[roomJSONpaths['roompath'][0]].areas
//         temp.map(each=>{
//             response.map(element=>{
//                 if(each.meeting_room_id==element.zoneId){
//                     each['fill']=element.color;
//                     each['value']=element.value.toFixed(2);
//                 }
//             })
//         })
//         defaultData[roomJSONpaths['roompath'][0]].areas=temp 
// }

//     useEffect((floorCoords) => {
       
//         let sensor_type = mapSubType === "noise" ||mapSubType === "co2"||mapSubType === "tvoc"||mapSubType === "pm2_5"||mapSubType === "pm10" ? "AQS_sensor" : "thl_sensor"
//         setStype(sensor_type)
//         let type = mapSubType === "aqi" ? "all" : mapSubType
     
//         api.floor.FloorMapGenerator01(localStorage.floorID, type,sensor_type ).then(res => {
//             defineFloorColor(defaultFloorCoords,res,roomSpecs);    
//             })
...
//         } else {
//             console.log("Invalid Coordinates Specified");
...
//             // Room Layout
//             mroom.fill = (mroom.fill != undefined) ? mroom.fill: 'none';
...
//                 <title>{mapSubType}:{item.value}</title>
//                     </rect>
//                 )}
//                 {roomShapes.map((item) => (
