      ...
      (response, callback) => {
        ...
        if (response.length > 0) {
          response.forEach(devId => {
            if (
              devId.message == 'Outside Air Damper-Position Mismatch'
              ) {
                            ...
                            // checking which alarm is this
                                ...
                                //     } else {
                                      ...
                                      // results2.forEach(input => {
                                        ...
                                        // if (comp.param_id == 'OA_Dmpr_Pos' &&
                                        // input.param_id ==
                                        //   'OA_Dmpr_Pos_SP') {
                                          // console.log('valueeeOA_Dmpr_Pos',comp.param_value);
                                            arr.push('OA_Dmpr_Pos Mismatch');
                                            arr.push(devId.id);
                                            ...
                                            console.log('OA_Dmpr_Pos Mismatch');
          ...
          if(err){
            ...
            inres.forEach(input=>{
              lateres.forEach(current=>{
                if(response[0] == 'OA_Dmpr_Pos Mismatch'){
                  ...
                  obj['OAD damper position'] = 'Check'
              }
              })
            })
            causes['OA_Dmpr_Pos Mismatch'] = obj;
