      ...
      (response, callback) => {
        ...
        if (response.length > 0) {
          response.forEach(devId => {
            if (
              devId.message == 'Chilled Water Valve-Position Mismatch'
              ) {
                            ...
                            // checking which alarm is this
                                ...
                                //     } else {
                                      ...
                                      // results2.forEach(input => {
                                        ...
                                        // if (comp.param_id == 'CHW_Vlv_Pos' &&
                                        // input.param_id ==
                                        //   'CHW_Vlv_Pos_SP') {
                                          // console.log('valueeeCHW_Vlv_Pos',comp.param_value);
                                          // if (input.param_value - comp.param_value > 20) {
                                            arr.push('CHW_Vlv_Pos is Mismatch');
                                            arr.push(devId.id);
                                            ...
                                            console.log('CHW_Vlv_Pos IS Mismatch');
                                            // console.log("alarm_code",devId.alarm_code)
                                          // } else if(input.param_id - comp.param_value < -20){
                                          //   arr.push('CHW_Vlv_Pos is Low');
                                          //   arr.push(devId.id);
                                          //   arr.push(devId.ss_id);
                                          //   // arr.push(input.param_value);
                                          //   controller.validatedAlarm(devId.id,(err,results3)=>{
                                          ...
                                          //     }
                                          //    })
                                          //   console.log('CHW_Vlv_Pos IS Low');
                                          // }else{
                                          //   arr.push('CHW_Vlv_Pos is Good');
                                          //   // callback(null, arr);
                                          //   console.log('CHW_Vlv_Pos IS GOOD');
                                          // }
                                        // }
                              //         });
                              //       }
          ...
          if(err){
            ...
            inres.forEach(input=>{
              lateres.forEach(current=>{
                if(response[0] == 'CHW_Vlv_Pos is Mismatch'){
            ...
            causes['CHW_Vlv_Pos Mismatch'] = obj;
            console.log("Im here",Object.values(causes).length)
