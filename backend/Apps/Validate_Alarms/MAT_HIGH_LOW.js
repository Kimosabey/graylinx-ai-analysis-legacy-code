      ...
      (response, callback) => {
        ...
        if (response.length > 0) {
          response.forEach(devId => {
            if (
              devId.message == 'Mixed Air Temperature Mismatch'
              ) {
                            ...
                            // checking which alarm is this
                                ...
                                //     } else {
                                      ...
                                      // results2.forEach(input => {
                                        ...
                                        // if (comp.param_id == 'MAT' &&
                                        // input.param_id ==
                                        //   'MAT_SP') {
                                          // console.log('valueeeMAT',comp.param_value);
                                          // if (comp.param_value > 40) {
                                            arr.push('MAT is Low');
                                            arr.push(devId.id);
                                            ...
                                            console.log('MAT IS Low');
                                            // console.log("alarm_code",devId.alarm_code)
                                          // } else if(comp.param_value < 10){
                                          //   arr.push('MAT is Low');
                                          //   arr.push(devId.id);
                                          //   arr.push(devId.ss_id);
                                            // arr.push(input.param_value);
                                            ...
                                            //  console.log('MAT IS Low');
                                          // }else{
                                          //   arr.push('MAT is Good');
                                          //   // callback(null, arr);
                                          //   console.log('MAT IS GOOD');
                              //             }
                              //           }
                              //         });
                              //       }
          ...
          if(err){
            ...
            // inres.forEach(input=>{
              lateres.forEach(current=>{
                if(response[0] == 'MAT is Low'){
                    if(current.param_id == 'MAT'){
                        if(current.param_value > 40){
                            obj['MAT sensor'] = 'Faulty'
                        }else if(current.param_value < 10){
                            obj['MAT sensor'] = 'Faulty'
                        }else{
                            obj['MAT sensor'] = 'Fine'
                            console.log("MAT sensor is working fine")
                        }
                    }
              }
              })
            // })
            causes['MAT HIGH/LOW'] = obj;
