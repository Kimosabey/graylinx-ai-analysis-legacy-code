      ...
      (response, callback) => {
        ...
        if (response.length > 0) {
          response.forEach(devId => {
            if (
              devId.message == 'Supply Air Damper Position Mismatch'
              ) {
                                      ...
                                      // results2.forEach(input => {
                                        ...
                                        //   'OA_Dmpr_Pos_SP') {
                                          // console.log('valueeeOA_Dmpr_Pos',comp.param_value);
                                            ...
                                            console.log('SA_Dmpr_Pos Mismatch');
          ...
          if(err){
            ...
            inres.forEach(input=>{
              lateres.forEach(current=>{
                if(response[0] == 'SA_Dmpr_Pos Mismatch'){
                  ...
                  obj['SAD damper position'] = 'Check'
              }
              })
            })
            causes['SA_Dmpr_Pos Mismatch'] = obj;
