      ...
      (response, callback) => {
        ...
        if (response.length > 0) {
          response.forEach(devId => {
            if (
              devId.message == 'Return Air Damper Position Mismatch'
              ) {
                            ...
                            // checking which alarm is this
                                ...
                                //     } else {
                                      ...
                                      // results2.forEach(input => {
                                        ...
                                        // if (comp.param_id == 'RA_Dmpr_Pos' &&
                                        // input.param_id ==
                                        //   'RA_Dmpr_Pos_SP') {
                                          // console.log('valueeeOA_Dmpr_Pos',comp.param_value);
                                            arr.push('RA_Dmpr_Pos Mismatch');
                                            arr.push(devId.id);
                                            ...
                                            console.log('RA_Dmpr_Pos Mismatch');
          ...
          if(err){
            ...
            inres.forEach(input=>{
              lateres.forEach(current=>{
                if(response[0] == 'RA_Dmpr_Pos Mismatch'){
                  ...
                  obj['RAD damper position'] = 'Check'
              }
              })
            })
            causes['RA_Dmpr_Pos Mismatch'] = obj;
